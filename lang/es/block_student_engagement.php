...
$string['settings_section_general'] = 'Actividad y participacion general';
$string['settings_section_report_export'] = 'Reporte y exportacion';
$string['settings_section_risk_base'] = 'Riesgo academico: activacion y base';
...
$string['active_days_threshold'] = 'Dias para considerar actividad reciente';
$string['active_days_threshold_desc'] = 'Si un estudiante tuvo actividad dentro de este rango de dias, se considera activo.';
$string['inactive_days_threshold'] = 'Dias para considerar inactividad';
$string['inactive_days_threshold_desc'] = 'Si un estudiante supera este rango sin actividad, se considera inactivo.';
$string['report_event_goal'] = 'Meta de eventos para el puntaje del reporte';
$string['report_event_goal_desc'] = 'Cantidad de eventos recientes necesarios para obtener el puntaje maximo por eventos (30 puntos).';
$string['export_max_rows'] = 'Limite de filas para exportacion directa';
$string['export_max_rows_desc'] = 'Cantidad maxima de filas permitida para exportar en XLSX de forma inmediata. Si se supera, la exportacion se bloquea para proteger el rendimiento.';
$string['risk_enabled'] = 'Activar calculo de riesgo academico';
$string['risk_enabled_desc'] = 'Calcula y guarda el nivel de riesgo por estudiante durante las tareas programadas.';
$string['risk_grade_weight'] = 'Peso del riesgo por nota (%)';
$string['risk_grade_weight_desc'] = 'Define cuanto influye la nota en el puntaje final de riesgo.';
$string['risk_completion_weight'] = 'Peso del riesgo por completitud (%)';
$string['risk_completion_weight_desc'] = 'Define cuanto influye el avance de completitud en el puntaje final de riesgo.';
$string['risk_inactivity_weight'] = 'Peso del riesgo por inactividad (%)';
$string['risk_inactivity_weight_desc'] = 'Define cuanto influyen los dias sin actividad en el puntaje final de riesgo.';
$string['risk_participation_weight'] = 'Peso del riesgo por participacion (%)';
$string['risk_participation_weight_desc'] = 'Define cuanto influyen los eventos recientes en el puntaje final de riesgo.';
$string['risk_inactivity_days_threshold'] = 'Dias sin actividad para riesgo maximo por inactividad';
$string['risk_inactivity_days_threshold_desc'] = 'Con esta cantidad de dias sin actividad se aplica el riesgo maximo en el factor de inactividad.';
$string['risk_event_goal'] = 'Eventos recientes para riesgo minimo por participacion';
$string['risk_event_goal_desc'] = 'Cantidad de eventos recientes necesaria para reducir al minimo el riesgo por participacion.';
$string['risk_level_observation_min'] = 'Puntaje minimo para nivel observacion';
$string['risk_level_observation_min_desc'] = 'Desde este puntaje, el estudiante pasa al nivel observacion.';
$string['risk_level_high_min'] = 'Puntaje minimo para nivel alto';
$string['risk_level_high_min_desc'] = 'Desde este puntaje, el estudiante pasa al nivel de riesgo alto.';
$string['risk_level_critical_min'] = 'Puntaje minimo para nivel critico';
$string['risk_level_critical_min_desc'] = 'Desde este puntaje, el estudiante pasa al nivel de riesgo critico.';
$string['risk_start_percentage'] = 'Inicio de etapa media del curso (%)';
$string['risk_start_percentage_desc'] = 'Desde este porcentaje de avance del curso, la evaluacion de riesgo usa severidad normal.';
$string['risk_critical_percentage'] = 'Inicio de etapa critica del curso (%)';
$string['risk_critical_percentage_desc'] = 'Desde este porcentaje de avance del curso, la evaluacion de riesgo usa mayor severidad.';
$string['risk_course_progress_mode'] = 'Como calcular el avance del curso para riesgo';
$string['risk_course_progress_mode_desc'] = 'Define el metodo para calcular el avance del curso y ajustar las etapas de riesgo.';
